...
<body>
    ...
    <label for="name">企业名称:${enterprise.ename }</label>
    </div>
     <div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <label for="time">注册时间:${enterprise.etime }</label>
    ...
    <a href="${pageContext.request.contextPath}/enterprise/upenterprise.do?eid=${enterprise.eid}">编辑</a>
...
function dele(uid,obj) {
    ...
    if(obj.value=="启用"){
    	...
    	$.post("${pageContext.request.contextPath}/user/start.do",{
            uid:uid
