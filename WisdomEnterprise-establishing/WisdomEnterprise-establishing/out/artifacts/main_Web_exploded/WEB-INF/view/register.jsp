...
<form role="form" action="/user/register.do">
    ...
    <%--<div class="form-group">
        ...
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">审核企业信息</label>
        </div>
        <div class="checkbox" name="power">
        <label><input type="checkbox" value="">审核招商信息</label>
    </div>
        <div class="checkbox" name="power">
        <label><input type="checkbox" value="">发布招商信息</label>
    </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">会员列表</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">会员添加</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">会员查询</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">会员删除</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">企业信息下载</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">发送报告</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">添加路演设备</label>
        </div>
        <div class="checkbox" name="power">
            <label><input type="checkbox" value="">编辑路演设备</label>
        </div>
    </div>--%>
    <div class="form-group">
